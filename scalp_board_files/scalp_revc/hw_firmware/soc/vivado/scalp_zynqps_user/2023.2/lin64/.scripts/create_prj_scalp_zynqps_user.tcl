...
# Tool version: 2023.2
# Description: TCL script for re-creating Vivado project 'scalp_zynqps_user'
#
...
set PRJ_DIR ".."
set prj_name "scalp_zynqps_user"
...
# Add packages sources
	...
	foreach j $vhdl_pkg_file_list {
		...
		set_property library axi_lib [get_files $j]
		set_property file_type {VHDL} [get_files $j]
		print_status "VHDL mode configured for the file $j" "OK"
	}
print_status "Add packages sources" "OK"
print_status "VHDL mode configured for packages sources" "OK"
